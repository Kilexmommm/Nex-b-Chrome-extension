...
chrome.runtime.onMessage?.addListener((message, _sender, sendResponse) => {
  ...
  chrome.runtime.sendNativeMessage('com.kilex.nex_b', { action: 'open', url: message.url })
    ...
    .catch(error => sendResponse({ ok: false, error: 'No se pudo conectar con el asistente macOS. Instálalo desde native-host/INSTALAR-MACOS.md y recarga nex.b. (' + (error.message || 'error desconocido') + ')' }));
  return true;
});
